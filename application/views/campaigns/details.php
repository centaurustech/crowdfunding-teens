...
<?php if (!$rs->is_new_campaign) {?>
	<div class="row alert alert-default" role="alert">
						Um presente de <span class="hightlight-dark-red">R$ 100,00</span> foi adicionado por Vô Antonio
					</div>
					<div class="row alert alert-default" role="alert">
						Um presente de <span class="hightlight-dark-red">R$ 200,00</span> foi adicionado por Mamãe
					</div>
					<div class="row alert alert-default" role="alert">
						Um presente de <span class="hightlight-dark-red">R$ 300,00</span> foi adicionado por Carlinho
					</div>
					<div class="row alert alert-default" role="alert">
						Um presente de <span class="hightlight-dark-red">R$ 50,00</span> foi adicionado por Anônimo
					</div>
					<div class="row alert alert-default" role="alert">
						Um presente de <span class="hightlight-dark-red">R$ 20,00</span> foi adicionado por Anônimo
					</div>
					<div class="row alert alert-default" role="alert">
						Um presente de <span class="hightlight-dark-red">R$ 300,00</span> foi adicionado por Tia Clô
					</div>
					<div class="row alert alert-default" role="alert">
						Um presente de <span class="hightlight-dark-red">R$ 300,00</span> foi adicionado por Tia Zefa
					</div>
	<?php } else {?>
	<div class="row alert alert-default" role="alert">
