...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="container home-header-buttons">
    <div class="row">
      <div class="col-sm-6">
        <a class="btn btn-lg btn-header-options centered" href="#" role="button">Quero presentear</a>
      </div>
      <div class="col-sm-6">
...
<?php foreach ($rs_camp_highlighted as $camp) {?>
		                      ...
		                      <img class="img-gift" src="<?php echo $camp->imgurl;?>">
							          ...
							          <h4><a class = "campaign-name" href="campaigns/details/1"><?php echo $camp->camp_name;?></a></h4>
