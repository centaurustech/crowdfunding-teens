...
$config['googleplus']['redirect_uri']     = 'http://www.betadevconsult.com.br/projects/crowdfunding-teens/login/google-plus-redirect-url';#Add redirect url which you add in google console.
